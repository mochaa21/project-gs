...
if (isset($_POST['simpan'])) {
    ...
    // Query Insert
    $query = "INSERT INTO publishers (nama_pub, negara) VALUES ('$nama_pub', '$negara')";
    
    if (mysqli_query($koneksi, $query)) {
        echo "<script>
                alert('Publisher Berhasil Ditambahkan!'); 
...
<head>
    ...
    <title>Tambah Publisher - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 260px; flex-shrink: 0;">
        ...
        <div class="p-3">
            ...
            <a href="publishers.php" class="mt-2 text-white">
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Tambah Publisher Baru</h2>

        <div class="card p-4">
            <form action="" method="POST">
                
                <div class="mb-3">
                    <label class="form-label fw-bold">Nama Publisher</label>
                    <input type="text" name="nama_pub" class="form-control" placeholder="Contoh: Xbox Game Studios" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold">Negara Asal</label>
                    <input type="text" name="negara" class="form-control" placeholder="Contoh: USA, Japan, South Korea" required>
                </div>

                <div class="mt-4">
                    <button type="submit" name="simpan" class="btn btn-primary px-4">
                        <i class="fas fa-save me-2"></i> Simpan Publisher
                    </button>
