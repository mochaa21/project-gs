...
if (isset($_POST['simpan'])) {
    ...
    // Query Insert
    $query = "INSERT INTO developers (nama_dev, website) VALUES ('$nama_dev', '$website')";
...
<head>
    ...
    <title>Tambah Developer - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Tambah Developer Baru</h2>
        ...
        <div class="card p-4">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_dev" class="form-control" placeholder="Contoh: Ubisoft" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="website" class="form-control" placeholder="www.ubisoft.com" required>
                    </div>
                </div>
