...
// Ambil data discounts, urutkan dari yang terbaru
$query = "SELECT * FROM discounts ORDER BY id_diskon DESC";
...
<head>
    ...
    <title>Master Diskon Event - GameStore</title>
...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 260px; flex-shrink: 0;">
        ...
        <a href="discounts.php" class="active"><i class="fas fa-percent me-2 w-25"></i> Discounts</a>
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Data Diskon & Event</h2>

        <div class="card p-4">
            <div class="mb-3">
                <a href="tambah_discount.php" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-1"></i> Tambah Event Diskon
                </a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-success fs-6">
                                    <i class="fas fa-tag me-1"></i> <?= $row['persentase']; ?>%
                                </span>
                            </td>
                            
                            <td class="text-center">
                                <a href="edit_discount.php?id=<?= $row['id_diskon']; ?>" class="btn btn-sm btn-warning text-white">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="hapus_discount.php?id=<?= $row['id_diskon']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus event diskon ini?');">
