...
if (isset($_GET['id'])) {
    ...
    // Ambil data publisher berdasarkan ID
    $query  = "SELECT * FROM publishers WHERE id_pub = '$id_pub'";
...
if (isset($_POST['update'])) {
    ...
    // Query Update
    $query_update = "UPDATE publishers SET nama_pub = '$nama_pub', negara = '$negara' WHERE id_pub = '$id_pub'";
    
    if (mysqli_query($koneksi, $query_update)) {
        echo "<script>
                alert('Data Publisher Berhasil Diupdate!'); 
...
<head>
    ...
    <title>Edit Publisher - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Edit Data Publisher</h2>
        ...
        <div class="card p-4">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_pub" class="form-control" value="<?= $data['nama_pub']; ?>" required>
                </div>
