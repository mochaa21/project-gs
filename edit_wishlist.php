...
if (isset($_GET['id'])) {
    ...
    // Ambil data wishlist lama
    $query  = "SELECT * FROM trx_wishlist WHERE id_wishlist = '$id_wishlist'";
...
if (isset($_POST['update'])) {
    ...
    $query_update = "UPDATE trx_wishlist SET 
                    id_user = '$id_user', 
                    id_game = '$id_game' 
    ...
    if (mysqli_query($koneksi, $query_update)) {
        echo "<script>
                alert('Data Wishlist Berhasil Diperbarui!'); 
...
<head>
    ...
    <title>Edit Wishlist - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Edit Wishlist User</h2>
        ...
        <div class="card p-4">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">Pilih Game Baru</label>
                ...
                <div class="mt-4">
                    <button type="submit" name="update" class="btn btn-warning text-white px-4">
                        <i class="fas fa-save me-2"></i> Update Wishlist
                    </button>
                </div>
