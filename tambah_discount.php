...
if (isset($_POST['simpan'])) {
    ...
    // Query Insert
    $query = "INSERT INTO discounts (nama_event, persentase) VALUES ('$nama_event', '$persentase')";
    
    if (mysqli_query($koneksi, $query)) {
        echo "<script>
                alert('Event Diskon Berhasil Ditambahkan!'); 
...
<head>
    ...
    <title>Tambah Diskon - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Tambah Event Diskon Baru</h2>
        ...
        <div class="card p-4">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_event" class="form-control" placeholder="Contoh: Summer Sale 2026" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">Masukkan angka 0 jika tidak ada diskon (Normal Price)</div>
                </div>
