...
// SQL JOIN KOMPLEKS: Menghubungkan Detail, Invoice, Judul Game, dan Nama Diskon
$query = "SELECT d.*, p.no_invoice, g.judul, disc.nama_event 
          FROM trx_pembelian_detail d
          JOIN trx_pembelian p ON d.id_beli = p.id_beli
          JOIN games g ON d.id_game = g.id_game
          JOIN discounts disc ON d.id_diskon = disc.id_diskon
...
<head>
    ...
    <title>Laporan Detail Pembelian - GameStore</title>
...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 260px; flex-shrink: 0;">
        ...
        <a href="trx_detail.php" class="active"><i class="fas fa-list me-2 w-25"></i> Detail Beli</a>
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Detail Item Terjual</h2>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="badge bg-secondary"><?= $row['no_invoice']; ?></span></td>
                            ...
                            <td>
                                <span class="badge bg-info text-dark">
                                    <i class="fas fa-gift me-1"></i> <?= $row['nama_event']; ?>
                                </span>
                            </td>
                        </tr>
                        <?php endwhile; ?>
