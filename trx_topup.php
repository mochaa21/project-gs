...
// SQL JOIN: Menghubungkan data Topup dengan User dan Metode Pembayaran
$query = "SELECT t.*, u.username, pm.nama_metode 
          FROM trx_topup t
          JOIN users u ON t.id_user = u.id_user
          JOIN payment_methods pm ON t.id_pm = pm.id_pm
          ORDER BY t.tanggal_topup DESC";
...
<head>
    ...
    <title>Laporan Topup Wallet - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 260px; flex-shrink: 0;">
        ...
        <a href="trx_topup.php" class="active"><i class="fas fa-money-bill me-2 w-25"></i> Topup Wallet</a>
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Riwayat Topup Wallet</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-info text-dark">
                                    <i class="fas fa-credit-card me-1"></i> <?= $row['nama_metode']; ?>
                                </span>
                            </td>
