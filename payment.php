...
$query = "SELECT * FROM payment_methods ORDER BY id_pm ASC";
...
<head>
    ...
    <title>Metode Pembayaran - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 260px; flex-shrink: 0;">
        ...
        <a href="payment.php" class="active"><i class="fas fa-wallet me-2 w-25"></i> Payment Methods</a>
    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="card p-4">
            <div class="mb-3">
                <a href="tambah_payment.php" class="btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle me-1"></i> Tambah Metode Baru
                </a>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $no++; ?></td>
                            <td class="fw-bold"><?= $row['nama_metode']; ?></td>
                            
                            <td class="text-danger fw-bold">
                                Rp <?= number_format($row['biaya_admin'], 0, ',', '.'); ?>
                            </td>
                            
                            <td class="text-center">
                                <a href="edit_payment.php?id=<?= $row['id_pm']; ?>" class="btn btn-sm btn-warning text-white">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="hapus_payment.php?id=<?= $row['id_pm']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus metode ini?');">
