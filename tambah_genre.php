...
<head>
    ...
    <title>Tambah Genre - GameStore Admin</title>
        ...
        <div class="card p-4">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_genre" class="form-control" placeholder="Contoh: MMORPG" required>
                </div>

                <div class="mt-4">
                    <button type="submit" name="simpan" class="btn btn-primary px-4">
                        <i class="fas fa-save me-2"></i> Simpan Genre
                    </button>
