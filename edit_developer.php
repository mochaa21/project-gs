...
if (isset($_GET['id'])) {
    ...
    $query  = "SELECT * FROM developers WHERE id_dev = '$id_dev'";
...
if (isset($_POST['update'])) {
    ...
    // Query Update
    $query_update = "UPDATE developers SET nama_dev = '$nama_dev', website = '$website' WHERE id_dev = '$id_dev'";
    
    if (mysqli_query($koneksi, $query_update)) {
        echo "<script>
                alert('Data Developer Berhasil Diupdate!'); 
...
<head>
    ...
    <title>Edit Developer - GameStore Admin</title>
...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 260px; flex-shrink: 0;">
        ...
        <div class="p-3">
            ...
            <a href="developers.php" class="mt-2 text-white">
    ...
    <div class="flex-grow-1 p-4">
        <h2 class="mb-4">Edit Data Developer</h2>

        <div class="card p-4">
            <form action="" method="POST">
                
                <div class="mb-3">
                    <label class="form-label fw-bold">Nama Developer</label>
                    <input type="text" name="nama_dev" class="form-control" value="<?= $data['nama_dev']; ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="website" class="form-control" value="<?= $data['website']; ?>" required>
                    </div>
                </div>
